            ...
            <div class="row text-center">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <p class="full-width">
                                <a class="btn btn-primary full-width" data-bs-toggle="collapse"
                        ...
                        <div class="col">
                            <p class="full-width">
                                <button class="btn btn-primary full-width" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                <div class="card card-body">
                                    Заполните форуму с почтой и именем и нажмите кнопку купить.
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample2">
                                <div class="card card-body">
                                    Воспользуйтесь инструментом под названием "ноги" и манипулируя им окажитесь в
                                    магазине.
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample3">
                                <div class="card card-body">
                                    Спрашиваете какая гарантия? Ответ: "зуб даю"
                                </div>
                            </div>
                        </div>
                        <body>
                        <table class="table">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>1</td>
                                <td>1500</td>
                                <td class="table-danger">Обработан</td>
                            </tr>
                            </tbody>
                        </table>
                        </tbody>
